...
namespace StarryForest.Signboard
{
    ...
    {
        public ExchangeRecipe(string id, ItemId outputItemId, int outputCount, IReadOnlyDictionary<ItemId, int> cost, bool isDailyReward = false)
        {
            Id = id;
