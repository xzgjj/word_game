...
- 核心闭环：木屋周围自由查看 -> 按建设需求收集材料 -> 修桥或布置家园 -> 自主进入游戏机 -> 像素小游戏 -> 返回主世界 -> 贴纸墙更新。
...
| 资源 | 来源领域 | 主要用途 | 反馈 |
| --- | --- | --- | --- |
| 木材 | 旁友森林树枝 | 修木桥、木栅栏、木屋外扩 | 木片飞入背包 |
| 石子 | 河岸浅滩 | 花圃、路牌底座、河岸灯底座 | 轻微水波与拾取声 |
| 花种 | 木屋周围和森林边缘 | 花圃、庭院装饰 | 地面出现小花标记 |
| 河贝 | 河岸 | 风铃、屋外摆件 | 河岸闪光 |
| 表情碎片 | 森林和游戏机附近 | 情绪外观、贴纸墙装饰 | 情绪按钮轻闪 |
| 旧卡带 | 空地游戏机 | 进入像素小游戏 | 游戏机屏幕点亮 |
| 星屑灯芯 | 夜晚河岸或空地 | 河岸灯、游戏机底座灯带 | 夜晚发光 |
| 贴纸 | 像素小游戏 | 贴纸墙、表情图鉴 | 贴纸飞回 HUD |
...
1. 玩家在木屋门口出生，HUD 显示“发现：空地有一台发光游戏机”，不显示任务列表。
2. 玩家查看木屋周围，看到贴纸墙、可摆放区域和建设清单；清单提示建设物需要哪些材料。
3. 玩家进入森林，拾取木材和表情碎片，资源飞入 HUD，建设清单中“木桥”变为可建设。
4. 玩家到河边，如果木材不足，桥节点显示“缺少 1 个木材”；如果木材足够，提示可修桥。
5. 玩家修桥后，河岸与空地连通，世界状态从“无法通过”变为“可通过”。
6. 玩家可以继续布置木屋周围，也可以走到空地游戏机；靠近游戏机后出现“拾起游戏卡带，进入像素模式？”。
7. 玩家确认后转场，HUD 切到像素布局，主角由圆形动态表情变为方块像素表情。
8. 玩家在小游戏中收集 3 个贴纸并到达出口。
9. 游戏返回空地，游戏机点亮；玩家回到木屋，贴纸墙新增贴纸。
