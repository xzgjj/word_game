...
- 木牌是生活记录入口，不是任务板：今日可换、图纸记录、小镇记录。
...
背包容量按“物品种类 + 3 个预留记录格”计算。当前 9 类物品对应 12 格。UI 采用分类页，不在开局一次性展开全部物品。

| 分类 | 用途 | 当前物品 |
| --- | --- | --- |
| 采集 | 从森林、河岸、河水直接获得 | 木材、石子、河贝、鱼 |
| 交换/货币 | 木牌兑换、进度纪念、后续经济系统占位 | 表情碎片、星屑灯芯、贴纸 |
| 建造种植 | 用于花圃、桥、路牌等建设链路 | 花种、木材、石子 |
| 室内/特殊 | 游戏机、贴纸墙、未来室内布置入口 | 旧卡带、贴纸 |

开局只显示木材、石子、花种三个基础类型；河贝、鱼、旧卡带、贴纸等必须收集或兑换后才显示。
...
6. 玩家靠近半损坏木桥按 `E`，材料足够则写入建设状态并显示修复后的桥。
7. 玩家从桥面通过河流，进入右侧空地发现游戏机。
8. 玩家拿到旧卡带后可自主进入像素小游戏，收齐贴纸再回到主世界。
9. 回家后贴纸墙更新，小镇记录和建设状态保留在本地存档。
